...
if(!location.pathname.includes('/share.html')&&!document.getElementById('ownerNotificationBellV2Script')){const s=document.createElement('script');s.id='ownerNotificationBellV2Script';s.src='owner-notification-bell.js?v=20260826-1';s.async=false;document.head.appendChild(s)}
